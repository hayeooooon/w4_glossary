...
import { createTermsFB } from "./redux/modules/termsList";
				...
				<form>
					...
					<InputArea>
						...
						<div className="info_box">
							...
							<Limit className="txt_limit">{description ? description.length : "0"} / 300</Limit>
						</div>
					</InputArea>
					<InputArea>
						<label>EXAMPLE</label>
						...
						<div className="info_box">
							...
							<Limit className="txt_limit">{example ? example.length : "0"} / 200</Limit>
						</div>
					</InputArea>
					<ButtonArea>
